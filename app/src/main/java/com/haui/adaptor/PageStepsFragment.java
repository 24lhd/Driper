 ...
 * <p>
 * <p>
 * Use the {@link PageStepsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PageStepsFragment extends Fragment {
     ...
     */
    public static PageStepsFragment newInstance(@NonNull final String pageText) {
        PageStepsFragment fragment = new PageStepsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = (TextView) view.findViewById(R.id.tv_steps);
        if (textView != null) {
